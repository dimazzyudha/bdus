/*! DataTables 1.10.10 Â©2008-2015 SpryMedia Ltd - datatables.net/license*/
(function(h) {
	...
	function Ia(a) {
		...
		for(f=b.length;
		e<f;
		e++)if(l=b[e],u=[],!l.sType&&l._sManualType)l.sType=l._sManualType;
		else if(!l.sType) {
			g=0;
			for(j=d.length;
			g<j;
	...
	function ib(a,b,c,d) {
		...
		e--) {
			...
			f++)if("number"===typeof q[f]&&0<=q[f]) {
				...
				for(i=l.length;
				j<i;
				j++)("_all"==q[f]||h(l[j].nTh).hasClass(q[f]))&&d(j,o)
			}
		}
		if(c) {
			e=0;
	...
	function kb(a) {
		...
		for(c=l.length;
		b<c;
		b++)f=l[b],d=h(f.nTh).addClass(f.sClass),i&&d.appendTo(e),a.oFeatures.bSort&&(d.addClass(f.sSortingClass),!1!==f.bSortable&&(d.attr("tabindex",a.iTabIndex).attr("aria-controls",a.sTableId),Oa(a,f.nTh,b))),f.sTitle!=d[0].innerHTML&&d.html(f.sTitle),Pa(a,"header")(a,d,f,o);
		i&&fa(a.aoHeader,g);
		...
		if(b) {
			...
			d++) {
				...
				f++)if(o=i=1,j[d][f]===k) {
					...
					for(;
					g[d][f+o]!==k&&g[d][f].cell==g[d][f+o].cell;
					) {
						for(c=0;
						c<i;
						c++)j[d+c][f+o]=1;
	...
	function O(a) {
		...
		if(-1!==h.inArray(!1,b))C(a,!1);
			...
			if(0!==i.length) {
				...
				valign:"top",colSpan:ca(a),"class":a.oClasses.sRowEmpty
			}
			).html(c))[0];
	...
	function nb(a) {
		...
		for(var f=a.sDom.split(""),g,j,i,o,l,q,u=0;
		u<f.length;
		u++) {
			g=null;
			j=f[u];
	...
	function ub(a) {
		var b=a.aoColumns,c=b.length,d=a.oFeatures,e=a.oPreviousSearch,f=a.aoPreSearchCols,g,j=[],i,o,l,q=W(a);
		g=a._iDisplayStart;
		...
		for(g=0;
		g<c;
		g++)o=b[g],l=f[g],i="function"==typeof o.mData?"function":o.mData,S.columns.push( {
	...
	function xb(a,b,c,d,e,f) {
		if(""!==b)for(var g=a.aiDisplay,d=Qa(b,d,e,f),e=g.length-1;
		0<=e;
