...
<body onload="window.print()">
	<center><b style="font-size: 20px">AGENDA KONTRAK</b><br>
	...
	<table>
		<thead>
			<tr>
				...
				<th width="17%">Nomor Kontrak</td>
				<th width="6%">Tgl.Awal Kontrak</td>
				<th width="6%">Dari</td>
				<th width="4%">Pengolah</td>
				<th width="4%">Tgl.Arsip</td>
				<th width="5%">Ket</td>
			</tr>
		</thead>
		<tbody>
